 ...
 *
 *   MODIFIED FOR EXTERNAL-VIDEOS PLUGIN TO RETURN ONLY NECESSARY FIELDS.
 *   The stock library does not correctly format the filtered GET request
 *   without the hack to the public function request on lines 71-110
 */
...
class Vimeo
{
     ...
     * @param string $fields_desired - Comma-separated string of fields to return SPECIAL TO EXTERNAL VIDEOS PLUGIN
     ...
     */
    public function request($url, $params = array(), $method = 'GET', $json_body = true, $fields_desired = '')
    {
        ...
        switch (strtoupper($method)) {
            case 'GET' :
                ...
                // NIMMO MODIFICATION APPENDS DESIRED FIELDS
                $curl_url = $curl_url . '&fields=' . $fields_desired;
