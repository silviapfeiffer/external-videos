...
class MEXP_EV_Dailymotion_Template extends MEXP_Template {
  ...
  public function item( $id, $tab ) {
    ?>
    <div id="mexp-item-dailymotion-<?php echo esc_attr( $tab ); ?>-{{ data.id }}" class="mexp-item-area mexp-item-dailymotion" data-id="{{ data.id }}">
   ...
   * Note there is no page_token on Dailymotion
   *
   * @param string $id  the id of the view
   * @param string $tab the tab were the user is right now
   */
