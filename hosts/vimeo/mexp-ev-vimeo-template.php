...
class MEXP_EV_Vimeo_Template extends MEXP_Template {
  ...
  public function item( $id, $tab ) {
    ?>
    <div id="mexp-item-vimeo-<?php echo esc_attr( $tab ); ?>-{{ data.id }}" class="mexp-item-area mexp-item-vimeo" data-id="{{ data.id }}">
   ...
   * Note there is no page_token on Vimeo
   *
   * @param string $id  the id of the view
   * @param string $tab the tab were the user is right now
   */
